        ...
        if (savedInstanceState == null) {
            ...
            val fragment = com.gorillamo.relationship.catalog.RelationshipDetailFragment()
                ...
                arguments = Bundle().apply {
                    putString(
                        com.gorillamo.relationship.catalog.RelationshipDetailFragment.ARG_ITEM_ID,
                        intent.getStringExtra(com.gorillamo.relationship.catalog.RelationshipDetailFragment.ARG_ITEM_ID)
                    )
                }
            }

            supportFragmentManager.beginTransaction()
                .add(R.id.relationship_detail_container, fragment)
                .commit()
        }
    }
